...
var works = [
	...
	},
	{
		...
		pic: "img/HabiticaAbroad_dashboad.PNG"
	},
	{
...
var created = {
	...
	<p>\
      <i class='devicon-html5-plain-wordmark tech-icon'></i> <i class='devicon-css3-plain-wordmark tech-icon'></i> <i class='devicon-javascript-plain tech-icon'></i>\
      <i class='devicon-bootstrap-plain-wordmark tech-icon'></i> <i class='devicon-jquery-plain-wordmark tech-icon'></i> <i class='devicon-git-plain-wordmark tech-icon'></i>\
      <i class='devicon-amazonwebservices-plain-wordmark tech-icon'></i> <i class='devicon-devicon-plain-wordmark tech-icon'></i>\
      <i class='devicon-gimp-plain tech-icon'></i> <i class='devicon-ubuntu-plain-wordmark tech-icon'></i>\
    </p>"
};

var frontEnd = {
	devicons: "<h4>Front End</h4>\
	<p>\
	<i class='devicon-html5-plain-wordmark colored tech-icon'></i> <i class='devicon-css3-plain-wordmark colored tech-icon'></i> <i class='devicon-javascript-plain colored tech-icon'></i>\
    <i class='devicon-bootstrap-plain-wordmark colored tech-icon'></i> <i class='devicon-jquery-plain-wordmark colored tech-icon'></i>\
    </p>"
};

var backEnd = {
	devicons: "<h4>Back End</h4>\
	<p>\
	<i class='devicon-ruby-plain-wordmark colored tech-icon'></i> <i class='devicon-rails-plain-wordmark colored tech-icon'></i>\
	<i class='devicon-csharp-plain-wordmark colored tech-icon'></i> <i class='devicon-dot-net-plain-wordmark colored tech-icon'></i>\
	<i class='devicon-java-plain-wordmark colored tech-icon'></i>\
	</p>"
};

var database = {
	devicons: "<h4>Database</h4>\
	<span>\
	<i class='devicon-postgresql-plain-wordmark colored tech-icon'></i> <i class='devicon-redis-plain-wordmark colored tech-icon'></i>\
	</span>"
};

var verdep = {
	devicons: "<h4>Versioning & Deployment</h4>\
	<p>\
	<i class='devicon-git-plain-wordmark colored tech-icon'></i> <i class='devicon-github-plain-wordmark tech-icon'></i> <i class='devicon-bitbucket-plain-wordmark colored tech-icon'></i>\
	<i class='devicon-heroku-plain-wordmark colored tech-icon'></i> <i class='devicon-amazonwebservices-plain-wordmark colored tech-icon'></i>\
	</p>"
};
